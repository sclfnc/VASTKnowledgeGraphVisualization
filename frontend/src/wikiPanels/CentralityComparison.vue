...
<template>
  ...
  >
    <div class="w-full bg-white rounded border border-slate-200 flex items-center justify-center text-slate-500" style="height: 400px;">
      Placeholder: CentralityComparison
    </div>
  </PanelShell>
</template>
